	...
	<form method="post" action="{{ route('documentos-editar', $documento->IdDocumento) }}">
		...
		<div class="row">
			...
			<div class="form-group">
				...
				<input type="text" value="{{ $documento->FechaAprovacion}}" name="fecha-aprovacion" class="form-control datetimepicker-input" data-target="#reservationdate" required/>
			...
			<div class="form-group">
			    ...
			    <input type="number" value="{{ $documento->Version }}" class="form-control" id="version" min="0" placeholder="Ingrese la versión del documento" name="version">
			</div>
		    </div>
