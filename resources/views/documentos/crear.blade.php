            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="codigo" name="codigo" placeholder="Ingrese el código del documento" maxlength="255">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select name="estandares[]" class="select2bs4" multiple data-placeholder="Seleccione los estandares" style="width: 100%;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                <input name="archivo" type="file" class="custom-file-input" id="exampleInputFile" accept="application/pdf, application/msword, .doc, .docx, .pdf, .xlsx, .ods, application/vnd.openxmlformats-officedocument.wordprocessingml.document" required>
