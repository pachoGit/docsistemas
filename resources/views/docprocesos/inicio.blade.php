...
@section('titulo-pagina', 'Documentos por Procesos Generales')
    ...
    <div class="row">
		...
		<div class="card-body">
			...
			<tbody>
				...
				<tr>
				    <td></td>
				    <td>{{ $proceso->get('NombreProceso') }}</td>
				    <td>{{ $proceso->get('CantidadDocumentos') }}</td>
				    <td class="text-center">
					<div class="btn-group">
					    <a href="{{ route('docprocesos-documentos', $proceso->get('IdProceso')) }}" type="button" class="btn btn-primary btn-block" title="Ver documentos"><i class="fa fa-eye"></i></a>
					</div>
				    </td>
				</tr>
			    @endforeach
