	...
	<div class="wrapper">
		...
		<ul class="navbar-nav ml-auto">
			...
			<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
				...
				<!-- Message Start -->
				<div class="media">
				    <img src="{{ asset('docsistemas/dist/img/user1-128x128.jpg') }}" alt="User Avatar" class="img-size-50 mr-3 img-circle">
				...
				<!-- Message Start -->
				<div class="media">
				    <img src="{{ asset('docsistemas/dist/img/user8-128x128.jpg') }}" alt="User Avatar" class="img-size-50 img-circle mr-3">
				    <div class="media-body">
					<h3 class="dropdown-item-title">
					    John Pierce
				...
				<!-- Message Start -->
				<div class="media">
				    <img src="{{ asset('docsistemas/dist/img/user3-128x128.jpg') }}" alt="User Avatar" class="img-size-50 img-circle mr-3">
				    <div class="media-body">
					<h3 class="dropdown-item-title">
					    Nora Silvester
